...
const QuickActionCard: React.FC<QuickActionCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={`absolute top-0 right-0 w-20 h-20 bg-blue-50 rounded-full -mr-10 -mt-10 opacity-50`}
      ></div>
 ...
 console.log("Daily data:", daily);
  const stats = daily && (user.role === "admin" || user?.permissions?.includes("transaction.view"))
    ? [
        {
          title: "مبيعات اليوم",
          value: `${Number(daily?.data?.total_sales || 0).toLocaleString() || 0} ج.م`,
          change: `${+daily?.data?.total_sales_change || 0}% من السابق`,
        ...
        },
        {
          ...
          value: `${Number(daily?.data?.average_invoice || 0).toLocaleString()} ج.م`,
          change: `${+daily?.data?.average_invoice_change||0}% من السابق`,
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-gray-600">
              إدارة شاملة لمتجرك ومخزونك بكل سهولة
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600">
                  تم إضافة 50 قطعة من المنتج ABC
                </p>
              </div>
