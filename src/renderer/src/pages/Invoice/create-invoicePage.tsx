  ...
  <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
    ...
    <div className="flex justify-between items-center">
      ...
      <Button
        ...
        variant="default"
        className="flex items-center gap-2 px-6 py-2 bg-[#1B67B3] hover:bg-blue-700 text-white font-medium shadow-md"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="relative">
          ...
          <input
            ...
            onChange={(e) =>
              handleDetailChange("customerPhone", e.target.value)
            }
            className="w-full pr-10 pl-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 read-only:bg-gray-100 read-only:cursor-not-allowed"
            readOnly={isReadOnly}
          />
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <input
                      ...
                      value={product.price}
                      onChange={(e) =>
                        onUpdatePrice(index, parseFloat(e.target.value) || 0)
                      }
      ...
      <div className="mb-6">
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div>
            ...
            {invoiceDetails.customerName || "غير محدد"}
          </div>
          <div>
...
F1 : عرض هذه المساعدة`);
  ...
  const handleUpdatePrice = (index: number, price: number) => {
    setProducts((prev) =>
      prev.map((product, i) => (i === index ? { ...product, price } : product))
    );
  };
  ...
  const addSampleProduct = async (barcode?: any) => {
    if (!searchValue.trim()) {
    ...
    const data = await dispatch(
      ProductByBarcode({ name: barcode || searchValue })
    );
  ...
  async function fetchPreviousInvoice(newInvoice = true) {
    ...
    const result = await dispatch(
      beforeInvoice({ id: newInvoice ? currentInvoiceId : null })
    );
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="space-y-3">
              <Button
                ...
                disabled={
                  isViewingArchived || isSaving || products.length === 0
                }
                className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-[#1B67B3] hover:bg-blue-700 text-white font-medium disabled:opacity-50"
              >
          ...
          <div className="p-6">
            ...
            <div className="space-y-4">
              <p className="text-gray-600">
                سيتم طباعة الفاتورة مع التفاصيل التالية:
              </p>
              <div className="bg-gray-50 p-4 rounded-lg">
                <p>
                  <strong>عدد المنتجات:</strong> {products.length}
                </p>
                <p>
                ...
                <p>
                  <strong>طريقة الدفع:</strong> {invoiceDetails.paymentType}
                </p>
              </div>
