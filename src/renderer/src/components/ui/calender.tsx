    ...
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date: any) =>
          date.toLocaleString(locale?.code || "ar", { month: "short" }),
        formatWeekdayName: (date: Date) =>
          date.toLocaleDateString(locale?.code || "ar", { weekday: "short" }),
        ...formatters,
      }}
      classNames={{
        ...
        nav: cn(
          ...
          dir === "rtl" ? "flex-row-reverse justify-between" : "justify-between",
